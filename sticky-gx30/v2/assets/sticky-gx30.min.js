document.addEventListener("DOMContentLoaded", function () {
  ...
  const t = "https://gx30-sticky-banner.netlify.app/assets/";
  ...
  a.setAttribute("id", "sticky-gx30"),
    a.classList.add("sticky-gx30--hidden", n),
    a.setAttribute("target", "_blank"),
    a.setAttribute("href", i.url[e]),
    document.body.appendChild(a),
    (a.innerHTML = o),
    setTimeout(() => {
      a.classList.remove("sticky-gx30--hidden");
    }, 1e3);
  const c = () => {
      a.classList.add("sticky-gx30--hidden"),
        setTimeout(() => {
          a.remove();
        }, 1e3);
    },
    r = document.querySelector(".sticky-gx30__close");
  r &&
