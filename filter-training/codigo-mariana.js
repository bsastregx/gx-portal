const UC = this;
// var button = document.getElementById("id-test");
// var container = document.getElementById("id-check");
// button.addEventListener("click",function(e) {
// container.classList.toggle("gx-multi-checkbox--opened");
...
let rowSelectsOuterWrapper = document.querySelector(
  ".row--selects-outer-wrapper"
);

//The internal wrapper of the selects | .row--selects-inner-wrapper
let rowSelectsInnerWrapper = document.querySelector(
  ".row--selects-inner-wrapper"
);

//The category inputs
let categoryCheckboxes = Array.from(
  document.querySelectorAll(".gx-category-checkbox")
);
...
function multiCheckboxLabelClickHandler(e) {
...
// }
// });
// UC.GetSelectedItems = JSON.stringify(selectedItemsIds)
// console.log("log items seleccionados " + UC.GetSelectedItems);
...
this.SelectedItems = JSON.stringify(selectedItemsIds);
// console.log("log items seleccionados " + this.GetSelectedItems);
// return selectedItemsIds;
// };
